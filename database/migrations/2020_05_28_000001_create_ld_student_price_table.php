...
class CreateLdStudentPriceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ld_student_price', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->text('content')->default(0)->comment('返回的数据');
    ...
    {
        Schema::dropIfExists('ld_student_price');
    }
}
